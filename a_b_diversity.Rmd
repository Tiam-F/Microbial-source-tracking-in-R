...
# Plot both Illumina and Nanopore in same plot
ill.nano.bray <- plot_grid(bray.nano, illu.bray,labels = c('A','B'))
ill.nano.bray

## Using combined phyloseq object to plot in same image
...
# Save the image 
ggsave("ill_vs_nano_3samplesS.png", plot = plot.3.genus.class, width = 30, height = 20, units = "cm",dpi=2000)
```
